defmodule HighSchoolSweetheart do
  ...
  """
  @doc """
  A function that take a name and return its first letter.
  ...
  @doc """
  A function take a name and return its first letter, uppercase,
  ...
  @doc """
  A function that take a full name, consisting of a first name and a last name
  ...
  @doc """
  A function take two full names and return the initials
  """
